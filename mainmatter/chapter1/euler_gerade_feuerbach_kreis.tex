...
\begin{enumerate}
	...
	{2}\Vert = \frac{1}{2}\Vert c-m \Vert = \frac{1}{2} \quad r_{\text{Umkreis}}$
	...
	\end{itemize}
	$\Rightarrow$ Das Dreieck \includegraphics[width=0.2\textwidth]
